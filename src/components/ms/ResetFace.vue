    ...
    >
      <div class="import_box">
        <div class="nav__box">
          ...
          <span
            :class="['nav__item',{'active':activeKey1}]"
            @click="modelImport"
            v-if="power[5014]&& activeKey1"
          >模型导入</span>
          <span
            :class="['nav__item',{'active':activeKey2}]"
            @click="imgImport"
            v-if="power[5015]&&activeKey2"
          >图片导入</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    save1() {
      ...
      // console.log(this.choseModelIdArr);
